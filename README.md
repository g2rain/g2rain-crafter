...
```bash
# 项目无需安装插件, 直接运行即可
mvn com.g2rain:g2rain-crafter:1.0.0:bootstrap
```
...
```bash
# 项目无需安装插件, 直接运行即可
mvn com.g2rain:g2rain-crafter:1.0.0:bootstrap -Dphase=skeleton
```
...
```bash
# 项目无需安装插件, 直接运行即可
mvn com.g2rain:g2rain-crafter:1.0.0:bootstrap -Dphase=foundry
```
